...
@include('users/include/report-header')
    <div class="row">
	        <div class="col-md-12">
	            <h1 class="p6-heading">PQ-i - Triangle Graph - Self</h1>
	            <h3 class="p6-title ml-3">(Scales) The figure on this page provides you with your average score on each of the scales of the PQ-i.</h3>
	...
	<div class="row" style="margin-top: 5%; margin-bottom: 10%;">
		<div class="col-md-7 offset-md-3">
		    <div class="p6-box">
                ...
                <div class="p6-text">
                    <h1 class="p6-self-cq">{{ number_format($self_avg->CQ,1) }}</h1>
                </div>
                <div class="p6-text" >
                    <h1 class="p6-self-bt" style="padding-top: 150px;">{{ number_format($self_avg->BT,1) }}</h1>
                </div>
                <div class="p6-text">
                    <h1 class="p6-self-eq">{{ number_format($self_avg->EQ,1) }}</h1>
                </div>
                <div class="p6-text">
                    <h1 class="p6-self-lq">{{ number_format($self_avg->LQ,1) }}</h1>
                </div>
            </div>
		</div>
	</div>
