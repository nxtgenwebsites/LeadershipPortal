<!-- Report Page 10 -->
		...
		<div class="row" style="margin-top: -20%;">
			<div class="chart-container">
				<div class="chart" style="height: 500px; width: 8in;" id="selfvs360">
