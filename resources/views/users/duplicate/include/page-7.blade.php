<section id="page-7">
	<div class="container page-attr tri-main-grid py-5">
		...
		<div class="self-summary">
			<h1 class="triheading">PQ-i - Triangle Graph - 360</h1>
			<h3 class="tri-title ml-3">The figure on this page provides you with your average score on each of the scales
				of the PQ-i.</h3>
		...
		<div class="tri-chart mx-auto my-5">
			<div class="tri-box">
				...
				<div class="tri-text">
					<h1 class="tri-self-cq">{{ number_format($_360_avg->CQ,1) }}</h1>
				</div>
				<div class="tri-text">
					<h1 class="tri-self-bt">{{ number_format($_360_avg->BT,1) }}</h1>
				</div>
				<div class="tri-text">
					<h1 class="tri-self-eq">{{ number_format($_360_avg->EQ,1) }}</h1>
				</div>
				<div class="tri-text">
					<h1 class="tri-self-lq">{{ number_format($_360_avg->LQ,1) }}</h1>
				</div>
			</div>
		</div>
