<!-- Report Page 8 -->
    ...
    <div class="row">
	        <div class="col-md-12">
	            <h1 class="p8-main-title">PQ-i Spider Graph – Self <span>(Subscales)</span></h1>
	            <h3 class="p8-sub-title ml-3">The figure on this page provides you with your average score on each of the subscales of the PQ-i. </h3>
	            <ul class="no-list-style p8-sub-title" style="margin-left: 5%;">
	    ...
	    <div class="row">
	        <div class="col-md-10 offset-md-1">
	            <div id="p8-chart" style="height:1000px; width:100%; margin-top:10px;"></div>
	        </div>
	    </div>
